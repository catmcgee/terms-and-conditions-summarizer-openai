...
def summarize(text: str):
    ...
    child_safety_prompt = "\n\nThe above is the terms and conditions for an application. Tell me up to five things it says about children and age restrictions. Be very specific. Tell me things that do not exist in every company's terms & conditions policies. Provide your answer in bullet points with a newline between each. End bullets with a period. Use this bullet • Format in markdown.\n\n"
    data_privacy_prompt = "\n\nThe above is the terms and conditions for an application. Tell me up to five things it says about data privacy and how data is used by the company, including if it follows GDPR. Be very specific. Tell me things that do not exist in every company's terms & conditions policies. Provide your answer in bullet points with a newline between each. End bullets with a period. Use this bullet • Format in markdown. \n\n"
    liabilities_prompt = "\n\nThe above is the terms and conditions for an application. Tell me up to five liabilities that a user faces when using the product. Tell me what is not covered by the terms and conditions. Mention anything about hacks, law enforcement when it comes to privacy, misuse of the platform, and more. Talk about responsibilities the user faces. Be very speific and tell me things that do not exist in every company's terms & conditions policies. Provide your answer in bullet points with a newline between each. End bullets with a period. Use this bullet • Format in markdown\n\n"
    extras_prompt = "\n\nThe above is the terms and conditions for an application. Tell me the three biggest takeaways that are of utmost important for all users to know. Be very specific. Focus on things that do not exist in all terms & conditions. Provide your answer in bullet points with a newline between each. End bullets with a period. Use this bullet • Format in markdown\n\n"
